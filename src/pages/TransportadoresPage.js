...
function TransportadoresPage() {
  ...
  // Estados do modal de adicionar - CORRIGIDO: nomes consistentes
  ...
  const [dadosNovoTransportador, setDadosNovoTransportador] = useState({
    ...
    ambito: [],
    modalidades: [],
    tiposervico: [], // CORRIGIDO: consistente com o resto do código
    tipocarga: [],   // CORRIGIDO: consistente com o resto do código
    zonacobertura: [], // CORRIGIDO: consistente com o resto do código
    outraszonas: ''
  });
  ...
  const handleAddTransportador = async (novoTransportador) => {
    try {
      ...
      // Resetar formulário - CORRIGIDO: nomes consistentes
      ...
      alert('Erro ao adicionar transportador. Verifique se todos os campos obrigatórios estão preenchidos.');
    }
  };
  ...
  const handleDeleteTransportador = async (id) => {
    try {
      ...
      alert('Erro ao eliminar transportador. Tente novamente.');
    }
  };
...
export default TransportadoresPage;